        ...
        children: [
            {
                path: '/level',
                name: 'level',
                component: () => import('../views/static/level.vue')
            },
            {
                path: '/loginLog',
                name: 'loginLog',
                component: () => import('../views/static/loginLog.vue')
            },
            {
                path: '/memberTag',
                name: 'memberTag',
                component: () => import('../views/static/memberTag.vue')
            },
            {
                path: '/receive',
                name: 'receive',
                component: () => import('../views/static/receive.vue')
            },
            {
                path: '/member',
                name: 'member',
